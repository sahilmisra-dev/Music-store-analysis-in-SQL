...
------------------------Easy-------------------------------
1Q: who is the most senoir most employee based on job title?
select*from employee
order by levels desc
limit 6

------------------------------------
2Q:which country have teh most invoices?
...
3Q: what are top3 values of total invoice
...
4Q:Which city has the best customers? 
...
select sum(total) as high_sale,billing_city from invoice
group by billing_city 
order by high_sale desc


--------------------------------------------------
5Q:Who is the best customer?
...
7Q:Lets invite the artists who have written the most rock music in our dataset.
...
9Q:Find how much amount spent by each customer on artists?
...
10QWe want to find out the most popular music Genre for each country.
